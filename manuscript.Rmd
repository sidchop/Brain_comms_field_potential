...
ortho2(x = template,   #Specify the background template
       ...
       col.y= rev(viridis::inferno(n = 500)), #Select the color scale. In this case I have used the viridis scale from the viridis package. 
       ...
       mfrow = c(1,1)) + 
  colorbar(breaks, col = rev(viridis::inferno(n=length(breaks)-1)), 
