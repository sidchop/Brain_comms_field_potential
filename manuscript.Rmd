...
author: "Sidhant Chopra, Löic Labache, Winnie Orchard, [...]"
date: "09/03/2022"
output:
...
require high-level knowledge of programming. These tools are flexible
and allow for generation of reproducible, high-quality and publication
ready brain visualisations in only a few lines of code (Figure 1),
especially within the R, Python and Matlab environments.
...
visualisation tools that already exist within your chosen programming
...
While well-curated 3D renderings can help with spatial localisation
(cite madan), in the end, static images can only provide an incomplete
representation of the data. A added advantage of some of code-based
tools is that you can generate 'rich' media like interactive figures or
animations, which can improve scientific communication of findings. Many
code-based software tools now allow for the generation of animated brain
visualisations (cite blog) or interactive widgets which allow users to
zoom, rotate and scroll through slices. Linking to or even embedding
these videos or interactive figures in papers can greatly enhance the
...
over overlaid images, colour scales, legend placement and other
...
[view_xifti_volume(xii, interactive = TRUE) in cifti tools]
...
fig1a <- ggplot() + annotation_custom(grid::rasterGrob(png::readPNG("data/fig1a.png"),
                                                       width=ggplot2::unit(1,"npc"),
                                                       height=ggplot2::unit(1,"npc")))

fig1b <- ggplot() + annotation_custom(grid::rasterGrob(png::readPNG("data/fig1b.png"),
                                                       width=ggplot2::unit(1,"npc"),
                                                       height=ggplot2::unit(1,"npc")))

fig1c <- ggplot() + annotation_custom(grid::rasterGrob(png::readPNG("data/fig1c.png"),
                                                       width=ggplot2::unit(1,"npc"),
                                                       height=ggplot2::unit(1,"npc")))

fig1d <- ggplot() + annotation_custom(grid::rasterGrob(png::readPNG("data/fig1d.png"),
                                                       width=ggplot2::unit(1,"npc"),
                                                       height=ggplot2::unit(1,"npc")))

fig1e <- ggplot() + annotation_custom(grid::rasterGrob(png::readPNG("data/fig1e.png"),
                                                       width=ggplot2::unit(1,"npc"),
                                                       height=ggplot2::unit(1,"npc")))


fig1f <- ggplot() + annotation_custom(grid::rasterGrob(png::readPNG("data/fig1f.png"),
                                                       width=ggplot2::unit(1,"npc"),
                                                       height=ggplot2::unit(1,"npc")))

fig1g1 <- ggplot() + annotation_custom(grid::rasterGrob(png::readPNG("data/fig1g1.png"),
                                                        width=ggplot2::unit(1,"npc"),
                                                        height=ggplot2::unit(1,"npc")))
fig1g2 <- ggplot() + annotation_custom(grid::rasterGrob(png::readPNG("data/fig1g2.png"),
                                                        width=ggplot2::unit(1,"npc"),
                                                        height=ggplot2::unit(1,"npc")))

fig1h <- ggplot() + annotation_custom(grid::rasterGrob(png::readPNG("data/fig1h.png"),
                                                       width=ggplot2::unit(1,"npc"),
                                                       height=ggplot2::unit(1,"npc")))

fig1i <- ggplot() + annotation_custom(grid::rasterGrob(png::readPNG("data/fig1i.png"),
                                                       width=ggplot2::unit(1,"npc"),
                                                       height=ggplot2::unit(1,"npc")))

patchwork <- fig1a/fig1b|(fig1c|fig1f)/fig1d|(fig1e|fig1g2)/fig1g1|fig1h/fig1i 
...
ortho2(x = template, 
  ...
  title(main = "Voxel Statistic Map")
dev.off()
...
overlay(x=robust_window(dti), y=atlas, 
  ...
  title("Voxel Atlas Overlay", line = 1.3)
dev.off()
...
#fig1g <- cowplot::plot_grid(cortex, subcortex, nrow = 1, rel_widths = c(1,.7))
