...
(cite madan), in the end, static 2D images can only provide an
incomplete representation of 3D or 4D data. A added advantage of some of
...
edge-level data. A more didactic introduction to these tools is provided
in a [collection of beginner friendly
R-Notebooks](https://github.com/sidchop/neuRo-vis-BrainHack-2021).
...
#loop this?
fig_name <- c('fig1a', 'fig1b', 'fig1c', 'fig1d', 'fig1e', 'fig1f', 'fig1g1', 'fig1g2', 'fig1h', 'fig1i')
figs <- list()
...
patchwork <- figs[[1]]/figs[[2]]|(figs[[3]]|figs[[6]])/figs[[4]]|(figs[[5]]|figs[[8]])/figs[[7]]|figs[[9]]/figs[[10]] 
...
(Fig 1A). Smoothing and re-sampling of images is sometimes required for
visualisation purposes, which can be achieved via the `ANTsR`
...
-   Although, with `ciftitools`, this becomes easier, as long as atlas
    follows the CIFTI convention.
